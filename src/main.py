...
# Database path - now in data directory
DATABASE_NAME = os.path.join(PROJECT_ROOT, "data", "student_management_system.db")

# Asset paths - now in src/assets directory
ASSETS_DIR = os.path.join(SCRIPT_DIR, "assets")
LOGO_PATH = os.path.join(ASSETS_DIR, "images", "logo.png")  # Recommended size: 64x64 pixels
COLLEGE_BANNER_PATH = os.path.join(ASSETS_DIR, "images", "college_banner.png") # Recommended size: 800x200 pixels
ID_CARD_BG_PATH = os.path.join(ASSETS_DIR, "images", "id_card_bg.png") # Recommended size: 400x250 pixels
    ...
    def upload_profile_picture(self):
        ...
        if file_path:
            try:
                ...
                new_path = os.path.join(PROFILE_PICTURES_DIR, new_filename)
