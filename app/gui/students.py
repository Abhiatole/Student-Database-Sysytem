...
class StudentManagementTab:
    ...
    def setup_student_management_tab(self, parent_frame):
        ...
        form_canvas = tk.Canvas(parent_frame)
        form_canvas.grid(row=0, column=0, sticky="ns")
        form_scrollbar = ttk.Scrollbar(parent_frame, orient="vertical", command=form_canvas.yview)
        form_scrollbar.grid(row=0, column=0, sticky="nse")
