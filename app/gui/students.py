...
class BinTab:
    ...
    def setup_bin_tab(self):
        """Setup the bin/trash tab for deleted students"""
        ttk.Label(self.parent_frame, text="🗑️ Deleted Students", 
                 font=("Helvetica", 16, "bold"), 
                 bootstyle="danger").pack(pady=10)
        
        # Info label
        info_label = ttk.Label(self.parent_frame, 
                              text="This section shows students that have been moved to bin. You can restore or permanently delete them.",
                              foreground="gray")
        ...
        placeholder = ttk.Label(content_frame, 
                               text="🗑️ Bin functionality will be implemented here\n\nThis will show deleted students and allow restoration.",
                               font=("Segoe UI", 12),
                               foreground="gray",
                               anchor="center")
