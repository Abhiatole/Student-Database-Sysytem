...
class MainApplication:
    ...
    def setup_student_management_tab(self, parent_frame):
        ...
        # Row 6 - Address (spanning multiple columns)
        ...
        button_frame.grid(row=6, column=0, columnspan=6, pady=15)
...
Status: {'Active' if student['enrollment_status'] == 1 else 'Inactive'}"""
    ...
    def draw_id_card_preview(self, student):
        ...
        # Photo placeholder
        self.id_card_canvas.create_rectangle(20, 60, 100, 140, outline="black", width=2, fill="white")
        self.id_card_canvas.create_text(60, 100, text="PHOTO", fill="gray", font=("Arial", 8))
